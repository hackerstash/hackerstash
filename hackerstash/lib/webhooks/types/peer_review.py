...
log = Logging(module='Webhook::PeerReview')


class PeerReview(Base):
    # The permitted list of hours
    time_remaining = [24, 8, 1]

    def __init__(self, payload: dict) -> None:
        """
        Initialise an instance of the PeerReview class
        :param payload: dict
        """
        ...
        for project in Project.query.all():
            if project.active_goals:
                for member in project.members:
                    ...
                    email_factory('peer_review', member.user.email, payload).send()
